        ...
        <div className="flex flex-col lg:flex-row h-full py-24">
          <div className="w-full h-full lg:w-[60%] px-6">
            ...
            <div className="mt-12">
              ...
              <p className="mb-12">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente ex voluptate suscipit, vitae veritatis quae odit. Iusto, optio molestias facilis suscipit soluta ipsa harum, amet magni tempore est tenetur rerum!</p>
          ...
          <div className="w-full h-full lg:w-[40%]">
            ...
            <div>
              ...
              <p className="mb-6">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci non recusandae officiis.</p>
